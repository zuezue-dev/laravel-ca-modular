...
class MakeDriverInterfaceCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'module:make-driver-interface {name} {--tenant=false}';

    /**
     * The console command description.
     * @var string
     */
    protected $description = 'Create driver interface for a given module name';
