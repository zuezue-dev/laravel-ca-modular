...
class MakeEntityCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'module:make-entity {name} {--tenant=false}';

    /**
     * The console command description.
     * @var string
     */
    protected $description = 'Create entity for a given module name';
    ...
    protected function getTemplateContents()
    {
        ...
        return (new Stub($this->getStubName(), [
            'NAMESPACE' => $this->getClassNamespace($module, 'entity', $this->getTenant()),
            'CLASS'     => $this->getClass(),
        ]))->render();
    }
    ...
    protected function getDestinationFilePath()
    {
        ...
        $migrationPath = GenerateConfigReader::read("entity");
